    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("enviar") != null) {
            ...
            if (request.getParameter("eleccion") == null) {
                ...
                error.append("Debe seleccionar un equipo para eliminarlo.<br>");
            }
            ...
            if (!error.toString().equals("")) {
                ...
                equipo.setIdEquipo(Integer.parseInt(request.getParameter("eleccion")));
                
                edao.deleteEquipo(equipo);

                url = "JSP/Equipoo/dEquipo.jsp";
            }
