 ...
 * @author Alex
 */
@WebServlet(name = "InsertarAlumno", urlPatterns = {"/insertAlumno"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("enviar") != null) {
            ...
            if (request.getParameter("nombre").equals("")) {
                error.append("Debe introducir un nombre.<br>");
            }

            if (request.getParameter("grupo").equals("")) {
                error.append("Debe introducir un grupo.<br>");
            }
            ...
            if (!error.toString().equals("")) {
                ...
                equipo = edao.getEquipo(Integer.parseInt(request.getParameter("idEquipo")));
                alumno.setEquipo(equipo);
                adao.addAlumno(alumno);

                url = "JSP/Alumno/cAlumno.jsp";
            }
